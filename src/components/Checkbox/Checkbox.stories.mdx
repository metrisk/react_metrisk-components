    ...
    {() => {
      ...
      return (
        <div>
          ...
          <Checkbox name={'checkbox'} value={values.includes('cat')} onChange={(value) => handleChange('cat', value)} />
          <Checkbox name={'checkbox'} value={values.includes('dog')} onChange={(value) => handleChange('dog', value)} />
          <Checkbox name={'checkbox'} value={values.includes('horse')} onChange={(value) => handleChange('horse', value)} />
        </div>
      )
    }}
  </Story>
  ...
  <Story name='Uncontrolled'>
    {() => {
      ...
      return (
        <div>
          <Text>Value: {`${value}`}</Text>
          <Checkbox id={'checkbox'} uncontrolled>Label</Checkbox>
        </div>
      )
    }}
  </Story>
